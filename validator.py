            ...
            if lst_dict_keywords:
                if lst_dict_remove_parts:
                    ...
                    self.controller.error(
                        log_caller=_caller,
                        log_message=f"Google Sheet Document '{ViewConstants.GoogleSheetDocumentName}' does not contain any REMOVE_PART entries in the REMOVE_PARTS tab.",
                    )
                    return False
            else:
                if show_error_message:
                ...
                self.controller.error(
                    log_caller=_caller,
                    log_message=f"Google Sheet Document '{ViewConstants.GoogleSheetDocumentName}' does not contain any KEYWORD entries in the KEYWORDS tab.",
                )
                return False
        else:
            if show_error_message:
